...
#define STRING_CONFIG_H_AUTHOR "(sielenk)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "sielenks Ender-3 Pro 4.2.7"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "FBF9C7C5-EF97-4FB3-A9AE-2022B84BFF3E"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48.2, -4.7, -0.9 }
